...
/**
 * Is a blue themed friendly (player) entity
 *
 * @author - Andreas Paridis
 * @version - Submition
 * @see Friendly - Abstract friendly class
 */
public class BlueRocket extends Friendly {
    ...
    GameView gameView; //The gameView object
     ...
     */
    BlueRocket(GameView gameView, int screenY, Resources resources) {
        ...
        /* Moving Animation */
        rocket1 = BitmapFactory.decodeResource(resources, R.drawable.player); // Animation 1
        rocket2 = BitmapFactory.decodeResource(resources, R.drawable.player2); // Animation 2

        /* Shooting Animation */
        rocketShoot1 = BitmapFactory.decodeResource(resources, R.drawable.shoot1); // Animation 1
        rocketShoot2 = BitmapFactory.decodeResource(resources, R.drawable.shoot2); // Animation 2
        rocketShoot3 = BitmapFactory.decodeResource(resources, R.drawable.shoot3); // Animation 3
        rocketShoot4 = BitmapFactory.decodeResource(resources, R.drawable.shoot4); // Animation 4
