...
/**
 * Is a red themed friendly (player) entity
 *
 * @author - Andreas Paridis
 * @version - Submition
 * @see Friendly - Abstract friendly class
 */
public class GreenRocket extends Friendly {
    ...
    GameView3 gameView; //The gameView object
     ...
     */
    GreenRocket(GameView3 gameView, int screenY, Resources resources) {
        ...
        /* Moving Animation */
        rocket1 = BitmapFactory.decodeResource(resources, R.drawable.green_player); // Animation 1
        rocket2 = BitmapFactory.decodeResource(resources, R.drawable.green_player2); // Animation 2

        /* Shooting Animation */
        rocketShoot1 = BitmapFactory.decodeResource(resources, R.drawable.green_shoot1); // Animation 1
        rocketShoot2 = BitmapFactory.decodeResource(resources, R.drawable.green_shoot2); // Animation 2
        rocketShoot3 = BitmapFactory.decodeResource(resources, R.drawable.green_shoot3); // Animation 3
        rocketShoot4 = BitmapFactory.decodeResource(resources, R.drawable.green_shoot4); // Animation 4
